...
namespace EOPAM_08
{
    internal class Persona
    {
        ...
        public string[] variedadNombres = { "Abbott", "Acosta", "Adan", "Adkins", "Aguilar", "Abby", "Abigail", "Adele", "Aaron", "Abdul", "Abe", "Abel", "Abraham", "Adam", "Adan", "Adolfo", "Adolph", "Adrian", "John", "ti", "thiago", "magda" };
        public string[] variedadSexo = { "masculino", "femenino" };
        public Persona(Random rnd)
        {
            nombre = variedadNombres[rnd.Next(0, variedadNombres.Length)];
            sexo = variedadSexo[rnd.Next(0, variedadSexo.Length)];
        }
